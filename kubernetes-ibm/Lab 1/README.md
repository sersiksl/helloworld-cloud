...
3. Provision a free cluster: 

   ```ibmcloud ks cluster-create --name <name-of-cluster>```

Note: Even provisioning a free kubernetes cluster requires is not available in a free IBM Cloud Account. You need to have a pay-as-you-go or subscription account.
...
4. In order to upload images to the IBM Cloud Container Registry, you need to know the URL of your registry - e.g. de.icr.io or us.icr.io. Running the following command:

    ```ibmcloud cr info```

will provide you with the url of your Container Registry.
...
Note: If you receive a different url for your Container Registry, please use this instead of us.icr.io.
